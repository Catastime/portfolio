...
const bookPages = [
  ...
  // Left page — Introduction heading on black paper
  {
    ...
    items: [
      ...
      { type: 'statement', text: 'I\'M TIM MOEDEKER,\nAN M.Sc.ARCHITECTURE\nAND LECTURER BASED\nIN HANNOVER\nWITH A PASSION FOR\nCUTTING EDGE\nTECHNOLOGIES OF THE\nDIGITAL WORLD AND,\nCONTRADICTORILY,\nANALOGUE PHOTOGRAPHY.', x: -4, y: 58.9, w: 108, h: 37.8, rotation: 0, aligns: { 3: 'left' } },
  ...
  // ===== SPREAD 13: IMPRESSUM — last page, black left, no right page =====
  {
    ...
    texture: 'left_page-black',
    items: [
      { type: 'text', text: 'TIM MOEDEKER\nSELMASTR. 7\n30451 HANNOVER\n\nTIM.MOEDEKER@GMAIL.COM\n+49 177 9000982\nTIMMKR.SPACE', x: -4, y: 40.5, w: 108, rotation: 0, fontSize: 0.85, fontSizeMobile: 0.46, weight: 300, align: 'justify' },
